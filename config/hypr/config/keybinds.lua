...
local terminal = _G.terminal or "ghostty"
...
hl.bind(mainMod .. " + TAB", hl.dsp.exec_cmd("qs -c overview ipc call overview toggle"))
...
hl.bind(mainMod .. " + F", hl.dsp.exec_cmd(_G.browser or "firefox"))
...
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd(os.getenv("HOME") .. "/.config/hypr/scripts/toggle-transparency.sh"))
